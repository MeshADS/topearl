<div class="myFormWizard">
    ...
    <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator">
        <li class="active">
            <a data-toggle="tab" href="#NSEtab1"><i class="fa fa-info tab-icon"></i> <span>Basic Info</span></a>
        </li>
        <li class="">
            <a data-toggle="tab" href="#NSEtab2"><i class="fa  fa-list tab-icon"></i> <span>List</span></a>
        </li>
        <li class="">
            <a data-toggle="tab" href="#NSEtab3"><i class="fa fa-lock tab-icon"></i> <span>Rules</span></a>
        </li>
        <li class="">
            <a data-toggle="tab" href="#NSEtab4"><i class="pg-grid tab-icon"></i> <span>Layout</span></a>
        </li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content" style="padding-left:0px; padding-right:0px;">
        <div class="tab-pane active slide" id="NSEtab1">
        ...
        <div class="tab-pane slide" id="NSEtab2">
            <div class="panel panel-transparent">
                <div class="panel-body listValues" id="listvaluesNSE" style="padding:0px 0px;">
                  
                </div>

                <div class="panel-body" style="padding-left:0px; padding-right:0px;">
                    <p class="text-center" id="eselectoptionsModalHelperNSE">
                        <small>
                            Click the plus sign to add a new select option
                        </small>
                    </p>
                    <button type="button" class="btn btn-block btn-complete addListvalue" data-id="NSE" data-helper="#eselectoptionsModalHelperNSE" data-target="#listvaluesNSE" title="Add a select option">
                        <i class="fa fa-plus-circle"></i>
                    </button>
                </div>
            </div>
        </div>
        <div class="tab-pane slide" id="NSEtab3">
             <div class="panel panel-transparent">
                <div class="panel-body" id="selectoptionsRules" style="padding:0px 0px;">
                    
                </div>

                <div class="panel-body" style="padding-left:0px; padding-right:0px;">
                    <div class="row p-r-35 m-t-10" id="selectoptions">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
        ...
        <div class="tab-pane slide" id="NSEtab4">
            <div class="panel panel-transparent">
                <div class="panel-body" style="padding-left:0px; padding-right:0px;">
                    <p>
                      <small>
