...
@section('jumbotron_breadcrumb')
	<ul class="breadcrumb">
	    ...
	    <li><a href="{{ URL::to('admin/classes') }}" class="active">Classes</a>
	    </li>
	</ul>
@stop
@section('jumbotron')
...
@section('content')
	...
	<div class="content-fluid">
					...
					<div class="modal fade slide-down disable-scroll" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								{{ Form::open(["url"=>"admin/classes", "role"=>"form"]) }}
									...
									<div class="modal-body">
										...
										<div class="form-group form-group-default m-t-10">
											...
											{{ Form::text("name", "", ["class"=>"form-control", "placeholder"=>"Enter class name here.."]) }}
										</div>
					...
					@foreach($list as $item)
						<div class="modal fade slide-down disable-scroll" id="editModal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									{{ Form::open(["url"=>"admin/classes/".$item->id, "role"=>"form", "method"=>"put"]) }}
										<div class="modal-header">
											<button class="close" data-dismiss="modal" aria-label="close">
												<span aria-hidden="true"><i class="fa fa-times"></i></span>
											</button>
										...
										<div class="modal-body">
											...
											<div class="form-group form-group-default m-t-10">
												{{ Form::label("name", "Name") }}
												<input type="text" name="name" class="form-control" placeholder="Enter class name here..." value="{{ $item->name }}">
											</div>
					...
					@foreach($list as $item)
						<div class="modal fade slide-down disable-scroll" id="deleteModal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $item->id }}" aria-hidden="true">
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									{{ Form::open(["url"=>"admin/classes/".$item->id, "role"=>"form", "method"=>"delete"]) }}
										<div class="modal-header">
											<button class="close" data-dismiss="modal" aria-label="close">
												<span aria-hidden="true"><i class="fa fa-times"></i></span>
											</button>
										...
										<div class="modal-body">
											...
											<p>
												Are you sure you want to delete this item, you will lose all data asscotiated with this class.
											</p>
				...
				{{-- Begin Bulk Delete Class Modal --}}
					<div class="modal fade slide-down disable-scroll" id="bulkDeleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								{{ Form::open(["url"=>"admin/classes/bulk", "role"=>"form", "method"=>"delete"]) }}
									<div class="modal-header">
										<button class="close" data-dismiss="modal" aria-label="close">
											<span aria-hidden="true"><i class="fa fa-times"></i></span>
										</button>
		...
		<div class="col-md-12">
			...
			{{ Form::open(["url"=>"admin/classes/bulk"]) }}
