...
@section('jumbotron_breadcrumb')
	<ul class="breadcrumb">
	    <li>
	      <a href="{{ URL::to('aadmin') }}"><i class="fa fa-home"></i></a>
	    </li>
	    <li><a href="{{ Request::url() }}" class="active">Posts</a>
	    </li>
	</ul>
@stop
@section('jumbotron')
		...
		<div class="col-md-12">
			<div class="panel panel-transparent">
				<div class="panel-body">
					...
					<a href="{{ URL::to('admin/admission/create') }}" class="btn btn-default btn-sm m-r-10"><i class="pg-plus"></i>&nbsp;Create</a>
					...
					<div class="modal fade slide-down disable-scroll" id="bulkDeleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
						...
						<div class="modal-dialog modal-sm">
							...
							<div class="modal-content">
								{{ Form::open(["url"=>"admin/admission/bulk", "role"=>"form", "method"=>"delete"]) }}
									...
									<div class="modal-body">
										...
										<p>
											Are you sure you want to delete these admission, you will lose all data asscotiated with them.
										</p>
								...
								<div class="panel panel-default">
									...
									<div class="panel-heading">
										...
										<div class="panel-controls">
											<ul>
								                <li>
								                	<a href="{{ URL::to('admin/admission/'.$item->id) }}" class="portlet-maximize" data-toggle="" title="Read"><i class="fa fa-eye"></i></a>
								                </li>
								                <li>
								                	<a href="{{ URL::to('admin/admission/'.$item->id.'/edit') }}" class="portlet-maximize" data-toggle="" title="Edit"><i class="fa fa-pencil"></i></a>
								                </li>
								                <li>
